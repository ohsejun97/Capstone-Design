# 실험 보고서 — SaProt-650M-kiba-3di-gnn

**생성일시:** 2026-03-31T20:51:00.220798
...
| 지표 | 값 | 설명 |
|---|---|---|
| **Pearson r** | **0.7191** | 예측-실측 선형 상관계수 (주 지표) |
| RMSE | 0.5783 | 평균 예측 오차 (pKd 단위) |
| MAE | 0.3691 | 평균 절대 오차 (pKd 단위) |
| CI | 0.7828 | 결합력 순위 일치도 (0.5=랜덤, 1.0=완벽) |
| Val best r | 0.7225 | 검증셋 최고 Pearson r |
...
| 항목 | 값 |
|---|---|
| 단일 샘플 추론 시간 | **0.991 ms** (± 0.233 ms) |
| 추론 속도 | **1009 samples/sec** |
| 학습 중 최대 VRAM | 2191.5 MB |
