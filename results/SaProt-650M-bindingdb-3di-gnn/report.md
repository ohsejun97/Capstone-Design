# 실험 보고서 — SaProt-650M-bindingdb-3di-gnn

**생성일시:** 2026-04-03T21:39:33.842364
...
| 지표 | 값 | 설명 |
|---|---|---|
| **Pearson r** | **0.8411** | 예측-실측 선형 상관계수 (주 지표) |
| RMSE | 0.8842 | 평균 예측 오차 (pKd 단위) |
| MAE | 0.5773 | 평균 절대 오차 (pKd 단위) |
| CI | 0.8459 | 결합력 순위 일치도 (0.5=랜덤, 1.0=완벽) |
| Val best r | 0.8348 | 검증셋 최고 Pearson r |
...
| 항목 | 값 |
|---|---|
| 단일 샘플 추론 시간 | **0.940 ms** (± 0.063 ms) |
| 추론 속도 | **1064 samples/sec** |
| 학습 중 최대 VRAM | 2191.2 MB |
