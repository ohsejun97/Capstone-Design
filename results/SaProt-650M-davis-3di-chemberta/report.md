# 실험 보고서 — SaProt-650M-davis-3di-chemberta

**생성일시:** 2026-04-01T16:08:20.740687
...
| 지표 | 값 | 설명 |
|---|---|---|
| **Pearson r** | **0.7889** | 예측-실측 선형 상관계수 (주 지표) |
| RMSE | 0.5647 | 평균 예측 오차 (pKd 단위) |
| MAE | 0.3106 | 평균 절대 오차 (pKd 단위) |
| CI | 0.8580 | 결합력 순위 일치도 (0.5=랜덤, 1.0=완벽) |
| Val best r | 0.7982 | 검증셋 최고 Pearson r |
...
| 항목 | 값 |
|---|---|
| 단일 샘플 추론 시간 | **0.944 ms** (± 0.120 ms) |
| 추론 속도 | **1059 samples/sec** |
| 학습 중 최대 VRAM | 1575.1 MB |
