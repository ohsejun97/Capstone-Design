...
**생성일시:** 2026-04-01T16:20:26.907963
...
| 지표 | 값 | 설명 |
|---|---|---|
| **Pearson r** | **0.7915** | 예측-실측 선형 상관계수 (주 지표) |
| RMSE | 0.5627 | 평균 예측 오차 (pKd 단위) |
| MAE | 0.3025 | 평균 절대 오차 (pKd 단위) |
| CI | 0.8608 | 결합력 순위 일치도 (0.5=랜덤, 1.0=완벽) |
| Val best r | 0.8009 | 검증셋 최고 Pearson r |
...
| 항목 | 값 |
|---|---|
| 단일 샘플 추론 시간 | **0.945 ms** (± 0.180 ms) |
| 추론 속도 | **1058 samples/sec** |
