...
- [x] 서버(500GB RAM)에서 전처리 완료 → `data/BindingDB/bindingdb_kd.csv` (85MB)
  - 최종 115,426쌍 / 고유 약물 32,480개 / 고유 타겟 2,384개 / pKd 2.00~15.00 (mean=6.30)
- [ ] `train_dti_saprot.py` bindingdb 케이스 CSV 읽기로 수정
